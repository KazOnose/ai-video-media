...
# Paths
$SourceImage = "C:\Users\admin\.gemini\antigravity\brain\6423ccf4-4a13-42ec-9526-0d9d3a0cde15\saiyou_douga_naisei_thumb_v4_1772539642101.png"
$DestDir = "C:\Users\admin\Desktop\ai-video-media\public\blog"
$DestFile = Join-Path $DestDir "saiyou-douga-naisei.png"
...
Write-Host "Cropped HR v4 thumbnail saved to: $DestFile"
